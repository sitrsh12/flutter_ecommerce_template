...
import '../shop/place_order.dart';

class AddAddressPage extends StatelessWidget {
  AddAddressPage(this.email);
  ...
  Widget build(BuildContext context) {
    Widget finishButton = InkWell(
      ...
      // I was facing issues while using card payment to I am directly diverting it to place order screen
      onTap: () => Navigator.pushNamed(context, PlaceOrder.routeName , arguments: email),
      child: Container(
        height: 80,
